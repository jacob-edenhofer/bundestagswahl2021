...
```{r importing-results-data, message=FALSE}
# election results 
## header
...
```{r data-structural-data-shapefile-merging, message=FALSE}
# shapefile
...
# variables 
btw21 <- btw21 %>%
  mutate(union_zweitstimmen_vorlaufig = ifelse(is.na(christlich_demokratische_union_deutschlands_zweitstimmen_vorlaufig), christlich_soziale_union_in_bayern_e_v_zweitstimmen_vorlaufig, christlich_demokratische_union_deutschlands_zweitstimmen_vorlaufig),
         CDU_CSU_Zweitstimmen_Share = union_zweitstimmen_vorlaufig/gultige_stimmen_zweitstimmen_vorlaufig,
         SPD_Zweitstimmen_Share = sozialdemokratische_partei_deutschlands_zweitstimmen_vorlaufig/gultige_stimmen_zweitstimmen_vorlaufig,
         FDP_Zweitstimmen_Share = freie_demokratische_partei_zweitstimmen_vorlaufig/gultige_stimmen_zweitstimmen_vorlaufig,
         AfD_Zweitstimmen_Share = alternative_fur_deutschland_zweitstimmen_vorlaufig/gultige_stimmen_zweitstimmen_vorlaufig,
         LINKE_Zweitstimmen_Share = die_linke_zweitstimmen_vorlaufig/gultige_stimmen_zweitstimmen_vorlaufig,
         Gruene_B90_Zweitstimmen_Share = bundnis_90_die_grunen_zweitstimmen_vorlaufig/gultige_stimmen_zweitstimmen_vorlaufig)
# final data set
## load 2017 election results 
setwd("C:/Users/jacob/Documents/R_documents/Data")
load("bundestagswahl2017_election_results.RData")
...
save(btws17_21_merged_plot, file = "bundestagswahlen_17_21_merged_plot_data.RData")
```
...
btw17_zweitstimmen_plot <- function(x){
  ...
  for(i in seq_along(nm)){
    ...
    print(plots)
    ggsave(filename = paste("btw_17", nm[i], "plots.png", sep = "_"))
  }
}
# applying loop
...
![](btw17_zweitstimmenanteile_overview.png)
...
btw21_zweitstimmen_plot <- function(x){
  ...
  for(i in seq_along(nm)){
    ...
    theme(plot.title = element_text(hjust = 0.5))
    print(plots)
    ggsave(filename = paste("btw_21", nm[i], "plots.png", sep = "_"))
  }
}
# applying loop
...
Before digging deeper into the results at the constituency-level, here is a plot of the overall results in 2017: 

![](btw21_zweitstimmenanteile_overview.png)
...
```{r loop-for-delta-plots, message=FALSE}
# loop
delta_loop <- function(x){
  ...
  theme(plot.title = element_text(hjust = 0.5),
    ...
    print(plots)
    ggsave(filename = paste("btw_21", lw[i], "delta_plots.png", sep = "_"))
  }
}
# apply loop
...
![Evolution des AfD-Zweitstimmenanteils](btw21_13 AfD_delta_21_13 plot.png)

![Evolution des CDU/CSU-Zweitstimmenanteils](btw21_13 CDU_CSU_delta_21_13 plot.png)

![Evolution des FDP-Zweitstimmenanteils](btw21_13 FDP_delta_21_13 plot.png)

![Evolution des Grüne/B90-Zweitstimmenanteils](btw21_13 Gruene_B90_delta_21_13 plot.png)
![Evolution des SPD-Zweitstimmenanteils](btw21_13_SPD_delta_21_13_plot.png)

![Evolution des LINKE-Zweitstimmenanteils](btw21_13_LINKE_delta_21_13_plot.png)


### Population Density and Vote Shares 


```{r correlation-plots-log-pop-vote-share-21, message=FALSE}
# data 
...
population_loop21 <- function(x){
  ...
  theme(plot.title = element_text(hjust = 0.5))
  print(plots)
  ggsave(filename = paste("btw_21_log_population_density_zweitstimmenanteil", db[i], "zweitstimmenanteil.png", sep = "_"))
  }
}
# loops
population_loop21_east_west <- function(x){
  ...
  theme(plot.title = element_text(hjust = 0.5))
  print(plots)
  ggsave(filename = paste("btw_21_log_population_density_ost_west_zweitstimmenanteil", db[i], "zweitstimmenanteil.png", sep = "_"))
  }
}
# apply loops
...
```{r correlation-young-voters-vote-shares, message=FALSE}
# loop
young_loop <- function(x){
  ...
  theme(plot.title = element_text(hjust = 0.5))
  print(plots)
  ggsave(filename = paste("btw_21_age_25_34", db[i], "zweitstimmenanteil.png", sep = "_"))
  }
}
## east-west
young_loop_east_west <- function(x){
  ...
  theme(plot.title = element_text(hjust = 0.5))
  print(plots)
  ggsave(filename = paste("btw_21_age_25_34", db[i], "east_west.png", sep = "_"))
  }
}
# applying loops
...
```{r correlation-old-voters-vote-shares, message=FALSE}
# loop
oldies_loop <- function(x){
  ...
  theme(plot.title = element_text(hjust = 0.5))
  print(plots)
  ggsave(filename = paste("btw_21_age_60_74", db[i], "zweitstimmenanteil.png", sep = "_"))
  }
}
## east-west
oldies_loop_east_west <- function(x){
  ...
  theme(plot.title = element_text(hjust = 0.5))
  print(plots)
  ggsave(filename = paste("btw_21_age_60_74", db[i], "east_west.png", sep = "_"))
  }
}
# applying loops
...
```{r disposable-income-vote-shares-loops, message=FALSE}
# loop
income_loop <- function(x){
  ...
  theme(plot.title = element_text(hjust = 0.5))
  print(plots)
  ggsave(filename = paste("btw_21_disposable_income", db[i], "zweitstimmenanteil.png", sep = "_"))
  }
}
## east-west loop
income_loop_east_west <- function(x){
  ...
  theme(plot.title = element_text(hjust = 0.5))
  print(plots)
  ggsave(filename = paste("btw_21_disposable_income", db[i], "east_west.png", sep = "_"))
  }
}
## applying loops 
...
```{r unemployment-rate-vote-shares-loops, message=FALSE}
# loop
unemployment_loop <- function(x){
  ...
  theme(plot.title = element_text(hjust = 0.5))
  print(plots)
  ggsave(filename = paste("btw_21_unemployment", db[i], "zweitstimmenanteil.png", sep = "_"))
  }
}
## east-west loop
unemployment_loop_east_west <- function(x){
  ...
  theme(plot.title = element_text(hjust = 0.5))
  print(plots)
  ggsave(filename = paste("btw_21_unemployment", db[i], "east_west.png", sep = "_"))
  }
}
## applying loops 
...
```{r arbeitslosengeld-ii-loop, message=FALSE}
# loop
unemployment_benefit_loop <- function(x){
  ...
  theme(plot.title = element_text(hjust = 0.5))
  print(plots)
  ggsave(filename = paste("btw_21_unemployment_benefit", db[i], "zweitstimmenanteil.png", sep = "_"))
  }
}
## east-west loop
unemployment_benefit_east_west <- function(x){
  ...
  theme(plot.title = element_text(hjust = 0.5))
  print(plots)
  ggsave(filename = paste("btw_21_unemployment_benefit", db[i], "east_west.png", sep = "_"))
  }
}
## applying loops 
...
```{r arbeitslosengeld-ii-loop-foreign, message=FALSE}
# loop
unemployment_benefit_foreign_loop <- function(x){
  ...
  theme(plot.title = element_text(hjust = 0.5))
  print(plots)
  ggsave(filename = paste("btw_21_unemployment_benefit_foreign", db[i], "zweitstimmenanteil.png", sep = "_"))
  }
}
## east-west loop
unemployment_benefit_foreign_loop_east_west <- function(x){
  ...
  theme(plot.title = element_text(hjust = 0.5))
  print(plots)
  ggsave(filename = paste("btw_21_unemployment_benefit_foreign", db[i], "east_west.png", sep = "_"))
  }
}
## apply loops 
...
electro_loop <- function(x){
  ...
  theme(plot.title = element_text(hjust = 0.5))
  print(plots)
  ggsave(filename = paste("btw_21_electro", db[i], "zweitstimmenanteil.png", sep = "_"))
  }
}
## east-west loop
electro_loop_east_west <- function(x){
  ...
  theme(plot.title = element_text(hjust = 0.5))
  print(plots)
  ggsave(filename = paste("btw_21_electro", db[i], "east_west.png", sep = "_"))
  }
}
## applying loops 
...
```{r companies-vote-share-loop, message=FALSE}
# loop
company_loop <- function(x){
  ...
  theme(plot.title = element_text(hjust = 0.5))
  print(plots)
  ggsave(filename = paste("btw_21_companies", db[i], "zweitstimmenanteil.png", sep = "_"))
  }
}
## east-west loop
company_loop_east_west <- function(x){
  ...
  theme(plot.title = element_text(hjust = 0.5))
  print(plots)
  ggsave(filename = paste("btw_21_companies", db[i], "east_west.png", sep = "_"))
  }
}
## applying loops 
...
```{r loops-no-hauptschulabschluss, message=FALSE}
# loop
hauptschul_loop <- function(x){
  ...
  theme(plot.title = element_text(hjust = 0.5))
  print(plots)
  ggsave(filename = paste("btw_21_ohne_hauptschulabschluss", db[i], "zweitstimmenanteil.png", sep = "_"))
  }
}
## east-west loop
hauptschul_loop_east_west <- function(x){
  ...
  theme(plot.title = element_text(hjust = 0.5))
  print(plots)
  ggsave(filename = paste("btw_21_ohne_hauptschulabschluss", db[i], "east_west.png", sep = "_"))
  }
}
## apply loops
...
abitur_loop <- function(x){
  ...
  theme(plot.title = element_text(hjust = 0.5))
  print(plots)
  ggsave(filename = paste("btw_21_abitur", db[i], "zweitstimmenanteil.png", sep = "_"))
  }
}
## east-west loop
abitur_loop_east_west <- function(x){
  ...
  theme(plot.title = element_text(hjust = 0.5))
  print(plots)
  ggsave(filename = paste("btw_21_abitur", db[i], "east_west.png", sep = "_"))
  }
}
# apply loops
